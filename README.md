...
this ID.  You can also specify `'all'` to apply the rule to all events (or contribution types).  If you
specify both `'all'` and a page ID, the page ID settings will override the `'all'` settings.
